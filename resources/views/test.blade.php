...
<meta name="twitter:title" content="Tailwind CSS Agency Landing Page - Flowbite">
...
<meta name="twitter:image" content="/marketing-ui/demo/images/og-image.jpg">

<!-- Facebook -->
<meta property="og:url" content="/landing/agency/">
<meta property="og:title" content="Tailwind CSS Agency Landing Page - Flowbite">
...
<meta property="og:image" content="/marketing-ui/demo/images/og-image.jpg">
...
<header>
    <nav id="mainNavbar" data-sticky="false" class="group dark:bg-transparent bg-transparent border-gray-200 py-2.5 fixed w-full z-40 top-0 start-0 data-[sticky=true]:bg-white data-[sticky=true]:border-b dark:data-[sticky=true]:bg-gray-800 dark:data-[sticky=true]:border-gray-700">
...
<flux:button x-data x-on:click="$flux.dark = ! $flux.dark" icon="moon" variant="subtle" aria-label="Toggle dark mode" />    
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1 bg-white dark:bg-gray-800 lg:bg-transparent lg:dark:bg-transparent mt-2 lg:mt-0" id="mobile-menu-2">
                <ul class="flex flex-col rounded-lg font-medium lg:flex-row lg:space-x-8">
                    <li>
                        <a href="" class="block py-2 pr-4 pl-3 text-gray-900 lg:text-white lg:group-data-[sticky=true]:text-gray-900 dark:lg:group-data-[sticky=true]:text-white hover:!text-primary-500 lg:group-data-[sticky=true]:hover:!text-primary-700 dark:lg:group-data-[sticky=true]:hover:!text-primary-500 border-b border-gray-100 hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700" aria-current="page">Home</a>
                    </li>
                    <li>
                        <a href="/services/services-1/" class="block py-2 pr-4 pl-3 text-gray-900 lg:text-white lg:group-data-[sticky=true]:text-gray-900 dark:lg:group-data-[sticky=true]:text-white hover:!text-primary-500 lg:group-data-[sticky=true]:hover:!text-primary-700 dark:lg:group-data-[sticky=true]:hover:!text-primary-500 border-b border-gray-100 hover:bg-gray-100 lg:hover:bg-transparent lg:border-0 lg:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Company</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#" class="block py-2 pr-4 pl-3 text-gray-900 lg:text-white lg:group-data-[sticky=true]:text-gray-900 dark:lg:group-data-[sticky=true]:text-white hover:!text-primary-500 lg:group-data-[sticky=true]:hover:!text-primary-700 dark:lg:group-data-[sticky=true]:hover:!text-primary-500 hover:bg-gray-100 lg:hover:bg-transparent lg:p-0 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
...
<section class="relative overflow-hidden bg-gray-900">
  <div class="absolute inset-0">
    <img class="object-cover w-full h-full" src="//images/agency-background.jpg" alt="">
  </div>
  ...
  <div class="max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:py-24">
    <div class="grid gap-8 sm:gap-16 lg:gap-20 md:grid-cols-2">
      ...
      <div class="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 sm:grid-cols-3 dark:text-gray-400">
        ...
        <a href="#" class="flex items-center justify-center">
          <svg class="h-10 hover:text-gray-900 dark:hover:text-white" viewBox="0 0 41 50" fill="currentColor"
            xmlns="http://www.w3.org/2000/svg">
            <path
