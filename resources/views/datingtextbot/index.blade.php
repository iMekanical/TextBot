<x-alert type="partials.head" brand="datingtextbot"x />
<!-- Twitter -->
...
<header>
<nav id="mainNavbar" data-sticky="true" class="group dark:bg-gray-800 bg-white border-gray-200 py-2.5 fixed w-full z-40 top-0 start-0 data-[sticky=true]:bg-white data-[sticky=true]:border-b dark:data-[sticky=true]:bg-gray-800 dark:data-[sticky=true]:border-gray-700">
<div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4">
@php($logoid="navbarlog")
@php($width="300")
@php($height="75")

<a href="/" class="flex items-center">
<div class="h-8 mr-3" /><x-logos.datingtextbot :logoid="$logoid" :height="$height" :width="$width"/> </div>
...
<button data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation" class="inline-flex items-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-xl px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
