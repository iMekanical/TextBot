...
<title>Tailwind CSS Kanban Board - Flowbite</title>

<link rel="canonical" href="http://krizzma.com:8813/pages/kanban/" />
...
<meta name="twitter:title" content="Tailwind CSS Kanban Board - Flowbite" />
<meta
...
<!-- Facebook -->
<meta property="og:url" content="http://krizzma.com:8813/pages/kanban/" />
<meta property="og:title" content="Tailwind CSS Kanban Board - Flowbite" />
<meta
        ...
        <div class="mb-6 flex items-start justify-start space-x-4 px-4 relative">
            ...
            <div class="min-w-[28rem]">
              <div class="flex items-center justify-between">
                <div class="py-4 text-base font-semibold text-gray-900 dark:text-gray-300">To Do</div>
                <button
                  id="group-dropdown-button-1"
                  type="button"
                  data-dropdown-toggle="group-dropdown-1"
                ...
                <div id="group-dropdown-1" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                  <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="group-dropdown-button-1">
                    <li>
                      <button
                        type="button"
                        id="addGroupButton"
              ...
              <div id="kanban-list-1" class="mb-4 min-w-[28rem] space-y-4">
                  
                  <div class="flex max-w-md cursor-move flex-col rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800">
                    <div class="flex items-center justify-between pb-4">
                      <div class="text-base font-semibold text-gray-900 dark:text-white">Change charts javascript</div>
                    ...
                    <div class="flex flex-col">
                      <div class="pb-4 text-sm font-normal text-gray-500 dark:text-gray-400">In _variables.scss on line 672 you define $table_variants. Each instance of "color-level" needs to be changed to "shift-color".</div>

                      <div class="flex justify-between">
                        <div class="flex items-center justify-start">
                            <a href="#" data-tooltip-target="user_32_1" class="-mr-3">
                              <img class="h-7 w-7 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/bonnie-green.png" alt="Bonnie Green" />
                            </a>
                            <div
                              id="user_32_1"
                              role="tooltip"
                            ...
                            <a href="#" data-tooltip-target="user_32_2" class="-mr-3">
                              <img class="h-7 w-7 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/roberta-casas.png" alt="Roberta Casas" />
                            </a>
                            <div
                              id="user_32_2"
                              role="tooltip"
                            ...
                            <a href="#" data-tooltip-target="user_32_3" class="-mr-3">
                              <img class="h-7 w-7 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/michael-gough.png" alt="Michael Gough" />
                            </a>
                            <div
                              id="user_32_3"
                              role="tooltip"
                  ...
                  <div class="flex max-w-md cursor-move flex-col rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800">
                    <div class="flex items-center justify-between pb-4">
                      <div class="text-base font-semibold text-gray-900 dark:text-white">Change homepage</div>
                      ...
                      <div class="flex items-center justify-center pb-4">
                        <img class="rounded-lg bg-contain shadow-xs dark:hidden" src="http://krizzma.com:8813/images/kanban/task-4.png" alt="attachment" />
                        <img class="rounded-lg bg-contain shadow-xs hidden dark:block" src="http://krizzma.com:8813/images/kanban/task-4-dark.png" alt="attachment dark" />
                      </div>
                    


                    <div class="flex flex-col">
                      <div class="pb-4 text-sm font-normal text-gray-500 dark:text-gray-400">Change homepage for Volt Dashboard.</div>
            ...
            <div class="min-w-[28rem]">
              <div class="flex items-center justify-between">
                <div class="py-4 text-base font-semibold text-gray-900 dark:text-gray-300">In Progress</div>
                <button
                  id="group-dropdown-button-2"
                  type="button"
                  data-dropdown-toggle="group-dropdown-2"
                  class="inline-flex items-center rounded-lg p-1 text-center text-sm font-medium text-gray-500 hover:bg-gray-200 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                >
                  <svg class="h-6 w-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-width="3" d="M12 6h0m0 6h0m0 6h0" />
                ...
                <div id="group-dropdown-2" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                  <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="group-dropdown-button-2">
                    <li>
                      <button
                        type="button"
                        id="addGroupButton"
              ...
              <div id="kanban-list-2" class="mb-4 min-w-[28rem] space-y-4">
                  
                  <div class="flex max-w-md cursor-move flex-col rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800">
                    <div class="flex items-center justify-between pb-4">
                      <div class="text-base font-semibold text-gray-900 dark:text-white">Redesign tables card</div>
                      ...
                      <div class="flex items-center justify-center pb-4">
                        <img class="rounded-lg bg-contain shadow-xs dark:hidden" src="http://krizzma.com:8813/images/kanban/task-1.jpg" alt="attachment" />
                        <img class="rounded-lg bg-contain shadow-xs hidden dark:block" src="http://krizzma.com:8813/images/kanban/task-1-dark.jpg" alt="attachment dark" />
                      </div>
            ...
            <div class="min-w-[28rem]">
              <div class="flex items-center justify-between">
                <div class="py-4 text-base font-semibold text-gray-900 dark:text-gray-300">Done</div>
                <button
                  id="group-dropdown-button-3"
                  type="button"
                  data-dropdown-toggle="group-dropdown-3"
                  class="inline-flex items-center rounded-lg p-1 text-center text-sm font-medium text-gray-500 hover:bg-gray-200 hover:text-gray-900 focus:outline-none dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
                >
                  <svg class="h-6 w-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-width="3" d="M12 6h0m0 6h0m0 6h0" />
                ...
                <div id="group-dropdown-3" class="z-10 hidden w-40 divide-y divide-gray-100 rounded-lg bg-white shadow-sm dark:divide-gray-600 dark:bg-gray-700">
                  <ul class="p-2 text-sm font-medium text-gray-500 dark:text-gray-400" aria-labelledby="group-dropdown-button-3">
                    <li>
                      <button
                        type="button"
                        id="addGroupButton"
              ...
              <div id="kanban-list-3" class="mb-4 min-w-[28rem] space-y-4">
                  ...
                  <div class="flex max-w-md cursor-move flex-col rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800">
                    <div class="flex items-center justify-between pb-4">
                      ...
                      <div class="flex items-center justify-center pb-4">
                        <img class="rounded-lg bg-contain shadow-xs dark:hidden" src="http://krizzma.com:8813/images/kanban/task-2.jpg" alt="attachment" />
                        <img class="rounded-lg bg-contain shadow-xs hidden dark:block" src="http://krizzma.com:8813/images/kanban/task-2-dark.jpg" alt="attachment dark" />
                      </div>
                  ...
                  <div class="flex max-w-md cursor-move flex-col rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800">
                    <div class="flex items-center justify-between pb-4">
                      <div class="text-base font-semibold text-gray-900 dark:text-white">Create Javascript elements</div>
            ...
            <div class="mb-4">
              ...
              <div class="flex items-center space-x-4">
                <div class="flex -space-x-4 sm:mb-0">
                  <img class="h-8 w-8 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/helene-engels.png" alt="Helene Engels" />
                  <img class="h-8 w-8 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/robert-brown.png" alt="Robert Brown" />
                  <img class="h-8 w-8 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/bonnie-green.png" alt="Bonnie Green" />
        ...
        <div class="mt-4">
          ...
          <div class="flex">
            <div class="me-3 hidden shrink-0 sm:flex">
              <img class="h-6 w-6 rounded-full" src="http://krizzma.com:8813/images/users/roberta-casas.png" alt="Roberta Casas" />
            </div>
          ...
          <article class="mb-6">
            <footer class="mb-2 flex w-full items-center justify-between">
              <a href="#" class="flex items-center">
                <img class="mr-2 h-6 w-6 rounded-full" src="http://krizzma.com:8813/images/users/roberta-casas.png" alt="Roberta Casas profile picture" />
