...
<title>Tailwind CSS User Feed Page - Flowbite</title>

<link rel="canonical" href="http://krizzma.com:8813/users/feed/" />
...
<meta name="twitter:title" content="Tailwind CSS User Feed Page - Flowbite" />
<meta
...
<!-- Facebook -->
<meta property="og:url" content="http://krizzma.com:8813/users/feed/" />
<meta property="og:title" content="Tailwind CSS User Feed Page - Flowbite" />
<meta
  ...
  <aside id="sidebar-contacts" class="hidden h-full min-w-80 overflow-y-scroll border-e border-gray-200 bg-white px-4 py-6 dark:border-gray-700 dark:bg-gray-800 md:sticky md:mb-0 md:block md:pb-0">
    ...
    <ul class="mb-4 space-y-4">
      <li class="flex items-center">
        ...
        />
        <img class="me-2 h-5 w-5 rounded-full" src="http://krizzma.com:8813/images/users/jese-leos.png" alt="jese avatar" />
      ...
      <li class="flex items-center">
        <input
          ...
          class="me-3 h-4 w-4 rounded-sm border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-700 dark:focus:ring-primary-600"
        />
        <img class="me-2 h-5 w-5 rounded-full" src="http://krizzma.com:8813/images/users/bonnie-green.png" alt="bonnie avatar" />
      ...
      <li class="flex items-center">
        <input
          ...
          class="me-3 h-4 w-4 rounded-sm border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-700 dark:focus:ring-primary-600"
        />
        <img class="me-2 h-5 w-5 rounded-full" src="http://krizzma.com:8813/images/users/joseph-mcfall.png" alt="Joseph avatar" />
      ...
      <li class="flex items-center">
        <input
          ...
          checked
        />
        <img class="me-2 h-5 w-5 rounded-full" src="http://krizzma.com:8813/images/users/neil-sims.png" alt="Neil avatar" />
      ...
      <li class="flex items-center">
        <input
          ...
          class="me-3 h-4 w-4 rounded-sm border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-700 dark:focus:ring-primary-600"
        />
        <img class="me-2 h-5 w-5 rounded-full" src="http://krizzma.com:8813/images/users/lana-byrd.png" alt="Lana avatar" />
      ...
      <li class="flex items-center">
        <input
          ...
          class="me-3 h-4 w-4 rounded-sm border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-700 dark:focus:ring-primary-600"
        />
        <img class="me-2 h-5 w-5 rounded-full" src="http://krizzma.com:8813/images/users/thomas-lean.png" alt="Thomas avatar" />
      ...
      <li class="flex items-center">
        <input
          ...
          checked
        />
        <img class="me-2 h-5 w-5 rounded-full" src="http://krizzma.com:8813/images/users/roberta-casas.png" alt="Roberta avatar" />
      ...
      <li class="flex items-center">
        <input
          ...
          class="me-3 h-4 w-4 rounded-sm border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-700 dark:focus:ring-primary-600"
        />
        <img class="me-2 h-5 w-5 rounded-full" src="http://krizzma.com:8813/images/users/robert-brown.png" alt="Robert avatar" />
      ...
      <li class="flex items-center">
        <input
          ...
          class="me-3 h-4 w-4 rounded-sm border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-700 dark:focus:ring-primary-600"
        />
        <img class="me-2 h-5 w-5 rounded-full" src="http://krizzma.com:8813/images/users/michael-gough.png" alt="Micheal avatar" />
      ...
      <li class="flex items-center">
        <input
          ...
          class="me-3 h-4 w-4 rounded-sm border-gray-300 bg-gray-100 text-primary-600 focus:ring-2 focus:ring-primary-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-700 dark:focus:ring-primary-600"
        />
        <img class="me-2 h-5 w-5 rounded-full" src="http://krizzma.com:8813/images/users/karen-nelson.png" alt="Karen avatar" />
    ...
    <ul class="mb-4 space-y-4">
      <li class="flex items-center">
        ...
        <div class="me-2 flex -space-x-3">
          <img class="h-5 w-5 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/jese-leos.png" alt="Jese avatar" />
          <img class="h-5 w-5 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/bonnie-green.png" alt="Bonnie avatar" />
        </div>
      ...
      <li class="flex items-center">
        ...
        />
        <div class="me-2 flex -space-x-3">
          <img class="h-5 w-5 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/lana-byrd.png" alt="Lana avatar" />
          <img class="h-5 w-5 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/joseph-mcfall.png" alt="Joseph avatar" />
        </div>
      ...
      <li class="flex items-center">
        ...
        />
        <div class="me-2 flex -space-x-3">
          <img class="h-5 w-5 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/robert-brown.png" alt="Robert avatar" />
          <img class="h-5 w-5 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/roberta-casas.png" alt="Roberta avatar" />
        </div>
      ...
      <li class="flex items-center">
        ...
        />
        <div class="me-2 flex -space-x-3">
          <img class="h-5 w-5 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/michael-gough.png" alt="Michael avatar" />
          <img class="h-5 w-5 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/robert-brown.png" alt="Robert avatar" />
        </div>
      ...
      <li class="flex items-center">
        ...
        />
        <div class="me-2 flex -space-x-3">
          <img class="h-5 w-5 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/neil-sims.png" alt="Neil avatar" />
          <img class="h-5 w-5 rounded-full border-2 border-white dark:border-gray-800" src="http://krizzma.com:8813/images/users/roberta-casas.png" alt="Roberta avatar" />
        </div>
  ...
  <div class="mb-5 h-full w-full overflow-hidden overflow-y-auto p-4">
      ...
      <div class="mb-4 space-y-4 rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 lg:space-y-6 2xl:p-6">
        <div class="flex items-center space-x-3">
          <div class="shrink-0">
            <img class="h-10 w-10 rounded-lg" src="http://krizzma.com:8813/images/users/neil-sims.png" alt="Neil Sims" />
          </div>
          <div class="min-w-0 flex-1">
            <a href="#" class="truncate font-semibold text-gray-900 hover:underline dark:text-white">Neil Sims</a>
            <p class="truncate text-sm text-gray-500 dark:text-gray-400">12 April at 09.28 PM</p>
          </div>
          <button
        ...
        <div class="space-y-4">
          <p class="text-base font-normal text-gray-500 dark:text-gray-400">Hi @everyone, the new designs are attached. Go check them out and let me know if I missed anything. Thanks!</p>
          
            <div class="flex">
                <img class="mr-4 h-32 w-32 rounded-lg sm:h-40 sm:w-40" src="http://krizzma.com:8813/images/feed/image-1.jpg" alt="task screenshot" />
              
                <img class="mr-4 h-32 w-32 rounded-lg sm:h-40 sm:w-40" src="http://krizzma.com:8813/images/feed/image-2.jpg" alt="task screenshot" />
              </div>
      ...
      <div class="mb-4 space-y-4 rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 lg:space-y-6 2xl:p-6">
        <div class="flex items-center space-x-3">
          <div class="shrink-0">
            <img class="h-10 w-10 rounded-lg" src="http://krizzma.com:8813/images/users/roberta-casas.png" alt="Roberta Casas" />
          </div>
          <div class="min-w-0 flex-1">
            <a href="#" class="truncate font-semibold text-gray-900 hover:underline dark:text-white">Roberta Casas</a>
            <p class="truncate text-sm text-gray-500 dark:text-gray-400">13 April at 10.55 PM</p>
          </div>
          <button
            id="notification-1-dropdown-button"
            type="button"
        ...
        <div class="space-y-4">
          <p class="text-base font-normal text-gray-500 dark:text-gray-400">I've been working on my app and grew it to $22k MMR in just a few years. Hard work pays off!</p>
