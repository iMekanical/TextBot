...
<title>Tailwind CSS Billing Page - Flowbite</title>

<link rel="canonical" href="http://krizzma.com:8813/e-commerce/billing/" />
...
<meta name="twitter:title" content="Tailwind CSS Billing Page - Flowbite" />
<meta
...
<!-- Facebook -->
<meta property="og:url" content="http://krizzma.com:8813/e-commerce/billing/" />
<meta property="og:title" content="Tailwind CSS Billing Page - Flowbite" />
<meta
  ...
  <div class="h-full overflow-y-auto border-r border-gray-200 bg-white px-3 py-4 dark:border-gray-700 dark:bg-gray-800">
    <ul class="space-y-2">
      ...
      <li>
        ...
        <div data-sidebar-collapse-hide>
          <ul id="dropdown-sales" class=" space-y-2 py-2">
            <li>
              <a
    ...
    <div class="mb-4 rounded-lg bg-white p-4 shadow-sm dark:bg-gray-800 sm:p-6">
      <div class="mb-4 flex items-center sm:mb-6">
        <a href="https://flowbite.com" class="me-3 flex items-center">
          <img src="http://krizzma.com:8813/images/logo.svg" class="me-2 sm:h-8" alt="Flowbite Logo" />
          <span class="self-center whitespace-nowrap text-2xl font-semibold dark:text-white">Flowbite</span>
        </a>
      ...
      <form action="#">
        <div class="mb-4 space-y-4 sm:mb-6 sm:space-y-6">
          ...
          <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-700">
            ...
            <img class="h-8 w-auto dark:hidden" src="http://krizzma.com:8813/images/e-commerce/brand-logos/visa.svg" alt="" />
            <img class="hidden h-8 w-auto dark:flex" src="http://krizzma.com:8813/images/e-commerce/brand-logos/visa-dark.svg" alt="" />
          </div>
          <!-- Radio Input -->
          <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-700">
            <div>
            ...
            <img class="h-7 w-auto dark:hidden" src="http://krizzma.com:8813/images/e-commerce/brand-logos/mastercard.svg" alt="" />
            <img class="hidden h-7 w-auto dark:flex" src="http://krizzma.com:8813/images/e-commerce/brand-logos/mastercard-dark.svg" alt="" />
          </div>
          <!-- Radio Input -->
          <div class="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-700">
            <div>
              <div class="mb-4 flex">
                ...
                <div class="ms-2 text-sm leading-none">
                  ...
                  <p id="helper-radio-text-card-3" class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-300">name@example.com</p>
                </div>
              </div>
              <div class="divide-x divide-gray-200 text-sm font-medium text-gray-500 dark:divide-gray-600 dark:text-gray-400">
                <a class="pe-1 hover:underline" href="#">Edit</a>
            ...
            <img class="h-8 w-auto dark:hidden" src="http://krizzma.com:8813/images/e-commerce/brand-logos/paypal.svg" alt="" />
            <img class="hidden h-8 w-auto dark:flex" src="http://krizzma.com:8813/images/e-commerce/brand-logos/paypal-dark.svg" alt="" />
          </div>
        </div>
        <button
